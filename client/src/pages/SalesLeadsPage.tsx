...
import { CheckSquare, Mail, MessageSquare, Phone, Plus, Search, Send, Users, X } from 'lucide-react';
        ...
        <div className="min-h-screen bg-[hsl(var(--background))] text-[hsl(var(--foreground))] p-4 md:p-8 lg:p-10 pt-20">
            <div className="max-w-[1500px] mx-auto space-y-6">
                ...
                <div className="bento-card overflow-hidden">
                    <div className="px-4 py-3 border-b border-slate-200 dark:border-slate-800 text-sm font-bold text-slate-500 dark:text-slate-400">
